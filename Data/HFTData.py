...
# File paths
input_file_path = 'DOGEUSDT-30m-2021-08.csv'  # Replace with your input file path
output_file_path = 'HFTData30min08.csv'  # Replace with your desired output file path
...
rsi_window = 7 # 7 for hft 18 for lft
data['RSI'] = ta.momentum.RSIIndicator(data['close'], window=rsi_window).rsi()

# Stochastic Oscillator
stoch_window = 7 # 7 for hft 18 for lft (also smooth window 4 for lft)
...
cci_window = 13 # 13 for hft 30 for lft
...
mfi_window = 7 # 7 for hft 18 for lft
...
cmf_window = 7 # 7 for hft 30 for lft
...
# Bollinger Bands
bollinger_window = 10 # 10 for hft 20 for lft
bollinger_std_dev = 2
...
atr_window = 8 # 8 for hft 18 for lft
...
# Calculate Aroon
aroon_window = 12  # 12 for hft 25 for lft
...
# ADX for High-Frequency Trading
adx_window = 5  # Shorter window for HFT
adx_indicator = ta.trend.ADXIndicator(high=data['high'], low=data['low'], close=data['close'], window=adx_window)
